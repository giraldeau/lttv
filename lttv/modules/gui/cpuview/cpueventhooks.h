...
GtkWidget *h_guicpucontrolflow(LttvPlugin *plugin);
...
int cpu_before_execmode_hook(void *hook_data, void *call_data);
int cpu_after_execmode_hook(void *hook_data, void *call_data);


int cpu_before_process_exit_hook(void *hook_data, void *call_data);
int cpu_before_process_release_hook(void *hook_data, void *call_data);
int cpu_after_process_exit_hook(void *hook_data, void *call_data);
int cpu_after_process_fork_hook(void *hook_data, void *call_data);
int cpu_after_fs_exec_hook(void *hook_data, void *call_data);
...
//void cpu_draw_closure(guint key, gpointer value, gpointer user_data);
...
int cpu_before_trace(void *hook_data, void *call_data);//replaced for cpu_before_request
int cpu_after_trace(void *hook_data, void *call_data);//replaced for cpu_after_request

gboolean cpu_filter_changed(void * hook_data, void * call_data);

void cpugram_show(CpuControlFlowData *cpucontrol_flow_data,guint draw_begin,guint draw_end);
