...
extern GdkColor cpu_drawing_colors[NUM_COLORS];
...
struct _cpuDrawing_t {
  GtkWidget *vbox;
  GtkWidget *drawing_area;
  /*
  GtkWidget *hbox;
  GtkWidget *viewport;
  GtkWidget *scrollbar;*///at this time,not necessary for cpugram
...
//void drawing_copy(cpuDrawing_t *drawing,
...
static void drawing_insert_square(cpuDrawing_t *drawing,
        guint y,
        guint height);

/* Remove a square corresponding to a removed process in the list */
static void drawing_remove_square(cpuDrawing_t *drawing,
        guint y,
        guint height);
...
void cpu_drawing_data_request_begin(EventsRequest *events_request,
                                LttvTracesetState *tss);
...
/* cpu_convert_pixels_to_time
 *
 * Convert from window pixel and time interval to an absolute time.
 */
static inline void cpu_convert_pixels_to_time(
    gint width,
    guint x,
...
static inline void cpu_convert_time_to_pixels(
    TimeWindow time_window,
    LttTime time,
    int width,
    guint *x)
